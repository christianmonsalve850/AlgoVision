...
import type { PatternItem, PatternName } from "@/features/practice/types/pattern-types";
...
export function PatternSidebarItem({ item, selected, onSelect }: PatternSidebarItemProps) {
